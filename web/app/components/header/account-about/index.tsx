            ...
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ...
                  : <>
                    <Link href='https://elevatesolutions.fr/politique-de-confidentialite/' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,<span> </span>
                    <Link href='https://elevatesolutions.fr' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
