const translation = {
  ...
  welcome: 'Bienvenue, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Community Edition, lisez le GitHub',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser.',
  licenseLostTip: 'Échec de la connexion au serveur de licences. Veuillez contacter votre administrateur pour continuer à utiliser.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser.',
